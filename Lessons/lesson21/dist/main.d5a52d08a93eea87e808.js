...
/* harmony export */ });
var nameTest = 'test';
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (nameTest);
...
console.log('nameTest:', _api_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
var myModal = new bootstrap__WEBPACK_IMPORTED_MODULE_2__.Modal(document.getElementById('myModal'));
var exampleEl = document.getElementById('tooltip');
var tooltip = new bootstrap__WEBPACK_IMPORTED_MODULE_2__.Tooltip(exampleEl);
var alertPlaceholder = document.getElementById('liveAlertPlaceholder');
var appendAlert = function appendAlert(message, type) {
  var wrapper = document.createElement('div');
  wrapper.innerHTML = ["<div class=\"alert alert-".concat(type, " alert-dismissible\" role=\"alert\">"), "<div>".concat(message, "</div>"), '</div>'].join('');
  alertPlaceholder.append(wrapper);
};
var alertTrigger = document.getElementById('liveAlertBtn');
alertTrigger.addEventListener('click', function () {
  var existingAlert = alertPlaceholder.querySelector('.alert');
  if (existingAlert) {
...
console.log(moment__WEBPACK_IMPORTED_MODULE_3__('10.11.1997', 'DD.MM.YYYY').format('MM-DD-YYYY'));
var dateOfBirth = prompt('Enter your date of birth in format DD/MM/YYYY');
console.log(moment__WEBPACK_IMPORTED_MODULE_3__(dateOfBirth, 'DD/MM/YYYY').format('YYYY/MM/DD'));
...
if (!dateOfBirth) {
  ...
  var _resultContainer = document.createElement('div');
  document.body.appendChild(_resultContainer);
  if (regex.test(dateOfBirth) && moment__WEBPACK_IMPORTED_MODULE_3__(dateOfBirth, 'DD/MM/YYYY', true).isValid()) {
    var result = moment__WEBPACK_IMPORTED_MODULE_3__(dateOfBirth, 'DD/MM/YYYY').format('YYYY/MM/DD');
    _resultContainer.innerHTML = "\n\t\t\t<div class=\"alert alert-success\" role=\"alert\">\n\t\t\t\tYour date of Birth: <strong>".concat(result, "</strong>\n\t\t\t</div>\n\t\t");
  } else {
...
/******/ })()
;
//# sourceMappingURL=main.d5a52d08a93eea87e808.js.map